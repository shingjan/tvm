...
def wmma_sync_impl_int8(a: T.handle, b: T.handle, c: T.handle) -> None:
    ...
    C = T.match_buffer(
        c, (16, 16), "int32", align=128, offset_factor=16, scope="wmma.accumulator"
    )
...
def wmma_store_desc_int8(a: T.handle, c: T.handle) -> None:
    A = T.match_buffer(
        a, (16, 16), "int32", align=128, offset_factor=16, scope="wmma.accumulator"
    )
...
WMMA_LOAD_A_INT8 = tir.TensorIntrin.register(
    "wmma_load_a_int8",
    wmma_load_a_desc_int8,
    wmma_load_a_impl_int8,
)

WMMA_LOAD_B_INT8 = tir.TensorIntrin.register(
    "wmma_load_b_int8",
    wmma_load_b_desc_int8,
    wmma_load_b_impl_int8,
)
...
WMMA_FILL_INT8 = tir.TensorIntrin.register(
    "wmma_store_int8",
    wmma_store_desc_int8,
    wmma_store_impl_int8,
)